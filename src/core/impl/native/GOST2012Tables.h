 ...
 * Based on reference implementation by Alexey Degtyarev <alexey@renatasystems.org>
 *
 * These tables combine S-box substitution, permutation, and linear transformation
 * for optimized XLPS computation in GOST R 34.11-2012.
 *
 * For little-endian systems (Windows, x86/x64)
 */
...
// Ax[position][byte] - Precomputed transformation tables
